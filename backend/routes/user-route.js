...
import { profileValidation } from "../middlewares/profile-validation.js";
...
user_router.post('/profile', profileValidation, validateRequest, createUserProfile);
user_router.put('/profile/:profileId', profileValidation, validateRequest, updateUserProfile);
